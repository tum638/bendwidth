...
const SignUp = ({ setPage }) => {
  ...
  useEffect(() => {
    const fetchLanguages = async () => {
      try {
        const response = await axios.get("https://api.drf.bendwidth.com/get-languages/");
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://api.drf.bendwidth.com/register/", {
        ...userData,
    ...
    <div className="login">
      ...
      <div className="login__content">
        ...
        <Stepper
          ...
          continueBtn={
            <button className="login__submit sign_up__button">Next</button>
          }
          backBtn={
            <button className="login__submit sign_up__button">Back</button>
          }
        >
          {/* Page 1 */}
          ...
          <div className="page__2">
            ...
            <div className="login__form_input">
              ...
              >
                ...
                <option value="Senior">Senior (Final Year/Graduate)</option>
              </select>
            </div>
        ...
        <p className="not_member">
          Already a user?{" "}
          <span className="login__signup" onClick={() => setPage("login")}>
            Login
          </span>
        </p>
      </div>
