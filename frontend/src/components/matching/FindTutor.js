...
const FindTutor = () => {
    ...
    <div className="tutor-wrapper" onChange={handleChangeInfo} >
        ...
        <div className="question-guideline question">
        ...
        <div className="question-title question">
            ...
            <p className="question-title-remark">Be specific and imagine you're asking a question to another person</p>
            <div className="question-title-inputs">
                <input id="course" type="text" name="course" placeholder="Which course is this question from?" />
                <input id="description" type="text" name="description" placeholder="e.g Is there an R function for finding the index of an element in a vector?" />
            </div> 
        </div>
        <div className="question-attempts question">
            <h5>What are the details of your problem?</h5>
            <p className="question-title-remark">Introduce your problem and expand on what you put in the title.</p>
            <textarea id="question-details" className="question-details" placeholder="e.g. In R, I have an element x and a vector v. I want to find the first index of an element in v that is equal to x. I know that one way to do this is: which(x == v)[[1]], but that seems excessively inefficient. Is there a more direct way to do it?">
        ...
        <div className="question-attempts question">
            ...
            <textarea id="question-attempts" className="question-details">
                
            </textarea>
        </div>
        <div className="tutor-preferences question">
            <h5>Tutor preferences</h5>
            <input id="gender" type="text" placeholder="What gender should your tutor be?" />
        </div>
                <div className="submit-question question" onClick={handleFindTutor}>{loading ? <CircularProgress /> : "Find Tutor"} 
                </div>
            </div>   
        </>)
}
