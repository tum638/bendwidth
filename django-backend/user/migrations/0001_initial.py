...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[(0, 'pending'), (1, 'denied'), (2, 'accepted')], default='pending', max_length=50)),
                ('uuid', models.CharField(max_length=200)),
                ('receivers', models.CharField(max_length=50)),
                ('timestamp', models.DateTimeField(auto_now=True)),
                ('sender', models.ForeignKey(max_length=100, on_delete=django.db.models.deletion.DO_NOTHING, related_name='invitations', to='user.userprofile')),
            ],
        ),
    ]
